...
<div id="wrapper">
        ...
        <div id="titleText">
            <div id="scope"><?php echo lang_get( 'plugin_Reporting_project' ); ?>: <?php echo project_get_name( $project_id ); ?></div><div id="sup"><?php if ( $project_id == ALL_PROJECTS ) { echo "<sup>&dagger;</sup>"; } ?></div>
        </div>
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="Reporting/test_mgo" />
				...
				<div class="btn-toolbar">
					<div class="btn-group pull-left">
						<?php
							...
							print_small_button( 'plugins/Reporting/pages/extract_csv.php', lang_get( 'csv_export' ) );
